...
$qryHal = $mysqli->query($sqlHal) or die(mysqli_error($mysqli));
...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Dancing+Script|Lobster">
  <style>
    ...
    .navtext {
      ...
      /* Ganti dengan nama font aksara sambung yang diinginkan */
      font-size: 24px;
    ...
    .navbar-text.headline{
      background-color: #2780E3;
    }

    .navbar-text.headline:hover {
      color: black;
    }
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav headline-container">
              <p class="navbar-text headline">Pilihan Berita</p>
              <li>
    ...
    <div class="row header-wrapper">
      <div class="container">
        <div class="header">
          ...
          <h4 class="site-description">Sumber Berita Ciwaas Depok tea</h4>
        </div>
